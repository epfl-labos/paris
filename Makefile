...
LDFLAGS = -z muldefs -static-libgcc -static-libstdc++ -Bstatic -L:$(BOOST_LIB_DIR) -l:libboost_system.a -l:libboost_thread.a -l:libboost_date_time.a -l:libprotobuf.a -lpthread -lrt ${PROF}
