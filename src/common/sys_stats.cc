...
namespace scc {
    ...
    std::atomic<int> SysStats::NumRecvUSTs(0);
    std::atomic<int> SysStats::NumSentUSTs(0);
    std::atomic<int> SysStats::NumSentUSTBytes(0);
    std::atomic<int> SysStats::NumRecvUSTBytes(0);
