...
namespace scc {
    ...
    public:
        ...
        static std::atomic<int> NumGSTRounds; // exchanged GST and UST in a data center
        ...
        static std::atomic<int> NumSentUSTs; // exchanged GSTs between data centers
        static std::atomic<int> NumRecvUSTs;
        static std::atomic<int> NumSentUSTBytes;
        static std::atomic<int> NumRecvUSTBytes;
